...
const GlobalFailedExamConfig = ({ onBack }) => {
    ...
    return (
        <div className="standard-exam-config">
            <div className="config-header">
                ...
                <h2>🌍 Examen de Fallos Globales</h2>
                <p>Configura tu examen basado en los errores globales. Puedes agregar múltiples configuraciones hasta 200 preguntas.</p>
            </div>
...
export default GlobalFailedExamConfig;
